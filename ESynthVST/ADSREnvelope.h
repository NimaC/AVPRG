#ifndef _SYNTH_ADSRENVELOPE_
#define _SYNTH_ADSRENVELOPE_
#include <cmath>
...
private:
	...
	void calculateMultiplier(double startLevel, double endLevel, unsigned long long lentghInSamples);
	unsigned long long currentSampleIndex;
	unsigned long long nextStageSampleIndex;
};
#endif _SYNTH_ADSRENVELOPE_
