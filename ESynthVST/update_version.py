...
def main():
  ...
  plistpath = scriptpath + "/resources/Synth-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Synth-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Synth-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Synth-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Synth-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Synth-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Synth.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Synth.iss",inplace=1):
